abstract class AppAssets {
  ...
  static const String distance = "$_iconsPath/distance.svg";
  static const String search = "$_iconsPath/search.svg";
  static const String smallArrowBack = "$_iconsPath/small_arrow_back.svg";
  ...
  static const String navigate = "$_iconsPath/navigate.svg";
  ...
  static const String attachImage = "$_iconsPath/attach_image.svg";
  static const String mapPin = "$_iconsPath/map_pin.svg";
  static const String language = "$_iconsPath/language.svg";
  static const String theme = "$_iconsPath/theme.svg";
